...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='gifts',
            field=models.ManyToManyField(to='create_form.Gift', null=True, through='form_response.RegistrationInstanceGifts', blank=True),
        ),
        migrations.AddField(
            model_name='formfieldinstance',
            name='registration_instance',
            field=models.ForeignKey(to='form_response.RegistrationInstance'),
        ),
    ]
